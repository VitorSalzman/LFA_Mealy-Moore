############ Este código foi retirado de: https://rosettacode.org/wiki/S-Expressions#Python  ##############

## Parser de S-Expressions ;;
## A sintaxe de definição para as máquinas de Mealy e Moore no presente trabalho é um caso particular de S-Expression
...
if __name__ == '__main__':
    ...
    sexp1 = ''' (mealy 
                ...
                (finals q3)
                (trans
                 ( q0 q1 a 0) ( q0 q3 b 0) ( q1 q2 b 1)
                 ( q1 q3 a 1) ( q2 q3 a 0) ( q2 q3 b 1) 
                 ( q3 q0 b 1) ( q3 q3 a 1 ) ) )'''
